...
// Базовая обертка для стандартных линейных иконок (viewBox 0 0 24 24)
...
// Специальная обертка для нестандартных SVG (например, логотипов)
const createCustomIcon = (viewBox, children) => (props) =>
  h(
    "svg",
    {
      xmlns: "http://www.w3.org/2000/svg",
...
// --- ИКОНКИ ДЛЯ МЕНЮ (из прошлого шага) ---
...
export const IconTrend = createIcon([
...
// Логотип Vue
export const IconLogoVue = createCustomIcon("0 0 128 128", [
...
// Поиск
export const IconSearch = createIcon([h("circle", { cx: 11, cy: 11, r: 8 }), h("path", { d: "m21 21-4.3-4.3" })]);
...
// Плюс / Добавить
export const IconPlus = createIcon([h("path", { d: "M5 12h14" }), h("path", { d: "M12 5v14" })]);
...
export const IconTable = createIcon([
  // Внешний контур таблицы (прямоугольник с скругленными углами)
  h("rect", {
    width: "18",
    height: "18",
    x: "3",
  ...
  // Горизонтальная линия (разделитель шапки)
  h("path", { d: "M3 9h18" }),
  // Вертикальная линия (разделитель колонок)
  h("path", { d: "M9 21V9" }),
]);
